  ...
  return (
    <div>
      ...
      <List style={{ paddingLeft: '20px', paddingTop: '5px' }}>
        <List.Item
          style={{
            color: validators[1](password) != undefined ? '#FF0000' : '#007F00',
          }}
        >
        ...
        <List.Item
          style={{
            color: validators[2](password) != undefined ? '#FF0000' : '#007F00',
          }}
        >
        ...
        <List.Item
          style={{
            color: validators[3](password) != undefined ? '#FF0000' : '#007F00',
          }}
        >
        ...
        <List.Item
          style={{
            color: validators[4](password) != undefined ? '#FF0000' : '#007F00',
          }}
        >
          - 1 caractère spécial
        </List.Item>
        <List.Item
          style={{
            color: validators[5](password) != undefined ? '#FF0000' : '#007F00',
          }}
        >
          - 1 majuscule
        </List.Item>
